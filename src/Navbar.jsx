    ...
    <>
      <nav className="flex justify-center items-center bg-andyblue text-white font-medium shadow-xl px-4">
        <div className="w-full max-w-[1920px] py-2 md:py-6 font-ubuntu flex justify-between items-center ">
          <h1 className="text-2xl md:text-4xl hover:text-andygold transition-colors duration-500 ease-in-out">
            INFORIUM
          </h1>

          <div className="hidden md:flex">
            <button className="text-xl font-medium mx-4 hover:text-andygold transition-colors duration-500 ease-in-out">
              ABOUT
            </button>
            <button className="text-xl font-medium mx-4 hover:text-andygold transition-colors duration-500 ease-in-out">
              SERVICES
